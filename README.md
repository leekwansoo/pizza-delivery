...
# replace PostgreSQL with Mysql for database
#  error fix:
## in schemas.py class Config, replace "schema_extra" with json_schema_extra
## downgrade the version for fastapi==0.991, fastapi_JWT_auth==0.5.0, pydantic=1.0.11
